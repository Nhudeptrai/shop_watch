...
Session::init();
include_once 'classes/product.php'; // Thêm include class product
include_once 'classes/cart.php';    // Thêm include class cart
?>
...
$pd = new product(); // Khởi tạo đối tượng product
$ct = new cart();    // Khởi tạo đối tượng cart
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['buy_now'])) {
    ...
    if ($quantity > $result_details['product_quantity']) {
        ...
        // Chuyển hướng trực tiếp đến order.php với thông tin sản phẩm và số lượng
        $redirect_url = "order.php?proid=" . $id . "&quantity=" . $quantity;
            ...
            <div>
                ...
                <form method="post" action="">
                    <div class="text-xl mb-4">
                        Số lượng:
                        <button type="button" onclick="changeNumber(-1)" class="border-1 border-red-700 bg-red-700 text-white cursor-pointer hover:bg-red-600 duration-150 rounded-ss-2xl rounded-es-2xl px-2 -me-2">−</button>
